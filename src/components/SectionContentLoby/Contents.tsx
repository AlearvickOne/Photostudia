export const contents = [
  {
    ...
    contentText: (
      <>
        <p>
          Светлый зал с хорошим естественным освещением, идеален <br /> для контентной, каталожной, тематической, предметной <br /> съемок, съемки
          личного бренда и бизнес-съемок.
        </p>
        <ul>
          <li>Широкий подоконник</li>
          <li>Реквизита для предметной съемки</li>
          <li>
            Переносная ванна в стиле Бали, с возможностью наполнения водой <br /> (можно перенести в другой зал)
          </li>
        </ul>
  ...
  },
  {
    ...
    contentText: (
      <>
        <p>
          Это большая площадка для АКВАСЪЕМКИ. Зал оборудован системами, <br />с помощью которых можно создавать крутые кадры с водой.
        </p>
        <ul>
  ...
  },
  {
    contentTitle: (
      <>
        <h2>ИНТЕРЬЕРНЫЙ</h2> <h3>Конференц-зал</h3>
      </>
    ),
    contentText: (
      <>
  ...
  },
  {
    contentTitle: (
      <>
        <h2>ЛОФТ</h2> <h3>Коворкинг</h3>
      </>
    ),
    contentText: (
      <>
        <p>
          Зал в стиле лофт с красивым естественным освещением!
          <br />
